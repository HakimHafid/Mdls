...
public class tampildepanruko extends AsyncTask<AssetManager, Void, Bitmap> {
    private static final String TAG = "depan ruko";
    ...
    public tampildepanruko(VrPanoramaView view, VrPanoramaView.Options viewOptions, String assetName) {
