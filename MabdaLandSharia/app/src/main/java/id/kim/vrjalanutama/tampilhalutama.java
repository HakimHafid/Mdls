...
public class tampilhalutama extends AsyncTask<AssetManager, Void, Bitmap> {
    private static final String TAG = "Hal utama";
    ...
    public tampilhalutama(VrPanoramaView view, VrPanoramaView.Options viewOptions, String assetName) {
