...
public class tampiljalanporos extends AsyncTask<AssetManager, Void, Bitmap> {
    private static final String TAG = "jalan poros";
    ...
    public tampiljalanporos(VrPanoramaView view, VrPanoramaView.Options viewOptions, String assetName) {
